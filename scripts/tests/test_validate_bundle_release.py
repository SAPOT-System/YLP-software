...
class ValidateBundleReleaseTests(unittest.TestCase):
    ...
    def test_accepts_matching_initial_release(self) -> None:
        values = validate(self.version_file, self.policy_file, "bundle/v0.0.1")
        self.assertEqual("0.0.1", values["version"])
    ...
    def test_rejects_floor_above_bundle_version(self) -> None:
