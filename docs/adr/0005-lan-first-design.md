...
See [deployment/operating-constraints.md](../deployment/operating-constraints.md) for the consolidated power/connectivity/degraded-mode/scale assumptions that follow from this decision.
